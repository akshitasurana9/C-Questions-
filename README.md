...
🚀 Program Features
🔹 Pattern 1 – Number Addition Format

Displays a formatted arrangement of numbers and calculates their sum.

🔹 Pattern 2 – Pyramid Star Pattern

Generates a centered pyramid pattern using asterisks (*) with the help of loops and formatting manipulators.

🔹 Pattern 3 – Decorative Star Pattern

Prints alternating rows of stars and dashes to create a unique design pattern.
...
iomanip Library (setw, setfill)
Pattern Printing Logic
📚 Learning Objectives

Through this practical assignment, I learned:

How to use formatting manipulators in C++
Pattern generation using nested logic
Function-based program organization
Basic Object-Oriented Programming (OOP) concepts
Improving problem-solving and coding skills
💻 Technologies Used
C++
Dev C++ / CodeBlocks / Turbo C++
Standard C++ Libraries
📂 File Information

File Name: Ass1akaq8.cpp

This file contains the complete source code for all three patterns implemented in the assignment.

**ASSIGNMENT 2**  
🚀 Program Features
🔹 Greatest Common Divisor (GCD)

This module accepts two numbers from the user and determines their Greatest Common Divisor (GCD) using an iterative approach.

🔹 Count and Sum of Even & Odd Digits

This module:

Counts the number of odd digits.
Counts the number of even digits.
Calculates the sum of odd digits.
...
Digit extraction using modulus (%) and division (/) operators.
...
Uses increasing and decreasing spacing to maintain symmetry.
Displays sequential numbers at the beginning and end of the pattern.
Replaces middle values with alternating 0 and 9 according to a defined logic.
🔹 Formatted Output
Utilizes the iomanip library for proper alignment.
Creates a visually organized pattern structure.
🛠 Concepts Used
C++ Programming
Classes and Objects
Nested Loops
...
iomanip Manipulators (setw, setfill)
Number Formatting and Logic Building
📚 Learning Outcomes

Through this assignment, I learned:

Designing complex patterns using nested loops.
Managing rows, columns, and spacing dynamically.
Using conditional operators for concise decision-making.
Applying formatting functions to improve output presentation.
...
Topics: Data structures, queue, inheritance, OOP
...
Student | Programming Learner | Aspiring Software Developer
